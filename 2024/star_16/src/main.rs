...
fn main() {
            ...
            for other_x in 0..width {
                for other_y in 0..height {
                    ...
                    if current == other {
                        ...
                        antinode_locations.insert((current_x as i64, current_y as i64));
                        let diff_x = current_x as i64 - other_x as i64;
                        let diff_y = current_y as i64 - other_y as i64;
                        let mut antinode_x = current_x as i64 + diff_x;
                        let mut antinode_y = current_y as i64 + diff_y;
    ...
    for (x, y) in antinode_locations.iter() {
